...
def get_tabs_html(mode="work"):
    ...
    <div class="tab-container">
        <div class="{work_class}">WORK</div>
        <div class="{rest_class}">REST</div>
    </div>
    """
...
#タイトル
st.markdown("<h1 class='main-title'>Pomodoro Timer</h1>", unsafe_allow_html=True)
